...
BASE_POPULATION_SCALE_FACTOR = 0.02 # For quick test simulations, this is set to a very low value
...
ingest_xlsm_filename = os.path.join('Data', 'calibration_ingest_form_ZWE_2022-07-15.xlsm')
